// components/TungstenSettingsForm.tsx - with responsive adjustments
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          <motion.button
            ...
            className="px-5 py-2.5 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 disabled:from-gray-400 disabled:to-gray-500 text-white text-sm font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 disabled:cursor-not-allowed flex items-center space-x-2"
          >
            {saveStatus === 'loading' ? (
              <>
