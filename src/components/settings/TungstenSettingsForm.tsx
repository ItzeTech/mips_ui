// components/TungstenSettingsForm.tsx
...
import {
  fetchTungstenSettings,
  saveTungstenSettings,
  resetSaveStatus,
  TungstenSettingsData
} from '../../features/settings/tungstenSettingSlice';
import {
  PercentBadgeIcon,
  CurrencyDollarIcon,
  ScaleIcon,
...
const TungstenSettingsForm: React.FC = () => {
  ...
  useEffect(() => {
    if (saveStatus === 'succeeded') {
      toast.success(t('settings.tungsten_saved_successfully'));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    dispatch(saveTungstenSettings(formData));
  };

  const handleInputChange = (field: keyof TungstenSettingsData, value: number) => {
  ...
  const formFields = [
    {
      key: 'rra_percentage' as keyof TungstenSettingsData,
    ...
    {
      key: 'rma_usd_per_ton' as keyof TungstenSettingsData,
    ...
    {
      key: 'inkomane_fee_per_kg_rwf' as keyof TungstenSettingsData,
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-20 pr-20 py-4 text-lg border-2 rounded-2xl focus:ring-4 focus:ring-yellow-500/20 focus:border-yellow-500 transition-all duration-200 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white ${
        ...
        >
          <motion.button
            ...
            className="px-8 py-4 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 disabled:cursor-not-allowed flex items-center space-x-2"
          >
            {saveStatus === 'loading' ? (
              <>
...
export default TungstenSettingsForm;