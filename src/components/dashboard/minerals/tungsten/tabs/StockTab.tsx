// components/dashboard/minerals/tungsten/tabs/StockTab.tsx
import { ScaleIcon } from '@heroicons/react/24/solid'
import { motion } from 'framer-motion'
import { StockFormData } from '../../../../../features/minerals/tungstenSlice';
  ...
  return (
    ...
    >
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
            <ScaleIcon className="w-5 h-5 mr-2 text-emerald-500" />
            {t('tungsten.stock_information', 'Stock Information')}
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <RenderInput
                label={t('tungsten.date_of_delivery', 'Date of Delivery')}
            ...
            <RenderSelect
                label={t('tungsten.stock_status_label', 'Stock Status')}
