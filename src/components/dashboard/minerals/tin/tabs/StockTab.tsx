// components/dashboard/minerals/tin/tabs/StockTab.tsx
import { ScaleIcon } from '@heroicons/react/24/solid'
import { motion } from 'framer-motion'
import { StockFormData } from '../../../../../features/minerals/tinSlice';
  ...
  return (
    ...
    >
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
            <ScaleIcon className="w-5 h-5 mr-2 text-amber-500" />
            {t('tin.stock_information', 'Stock Information')}
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <RenderInput
                label={t('tin.date_of_delivery', 'Date of Delivery')}
            ...
            <RenderSelect
                label={t('tin.stock_status_label', 'Stock Status')}
