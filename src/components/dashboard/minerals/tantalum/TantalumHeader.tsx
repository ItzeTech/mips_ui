// // components/dashboard/minerals/tantalum/TantalumHeader.tsx
...
//             className="w-full sm:w-auto inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600 hover:from-emerald-700 hover:via-teal-700 hover:to-green-700 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
//           >
//             <CalculatorIcon className="w-5 h-5 mr-2" />
//             <span className="whitespace-nowrap">{t('tantalum.compute_selected', 'Compute')} ({getCountByType('tantalum')})</span>
...
//           className="w-full sm:w-auto inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 text-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
//         >
//           <PlusIcon className="w-5 h-5 mr-2" />
//           <span className="whitespace-nowrap">{t('tantalum.create_new', 'Add New Tantalum')}</span>
...
//           animate={{ opacity: 1, y: 0 }}
//           exit={{ opacity: 0, y: -20 }}
//           className="mt-4 p-3 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-800 rounded-xl flex items-center justify-between"
//         >
//           <div className="flex items-center">
//             <CheckBadgeIcon className="w-5 h-5 text-indigo-600 dark:text-indigo-400 mr-2" />
